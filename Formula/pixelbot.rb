class Pixelbot < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/pixel-labs-id/pixelbot/releases/download/v1.7.5/pixelbot-1.7.5-darwin-arm64.tar.gz"
      sha256 "9af4770085879cdcb75fa914e6ba0a8037cb0db0ad88f28167fa944c6f8d06c8"
    else
      url "https://github.com/pixel-labs-id/pixelbot/releases/download/v1.7.5/pixelbot-1.7.5-darwin-amd64.tar.gz"
